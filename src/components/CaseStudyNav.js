    ...
    <aside id="sideNav" className={`${navStyle} translate-x transform transition duration-700 hidden h-0`}>
      <ul className={ulStyle}>
        ...
        <li data-section="section-3" className={listElementStyle}>
          ...
          <ul className={subUlStyle}>
            <li data-section="section-3-1" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-3-1")}>3.1 Horizontal Scaling</button>
            </li>
            <li data-section="section-3-2" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-3-2")}>3.2 Considerations for Managing Containerized Applications Across Compute Instances</button>
            </li>
            <li data-section="section-3-3" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-3-3")}>3.3 Container Orchestration</button>
            </li>
            <li data-section="section-3-4" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-3-4")}>3.4 Docker Swarm Mode</button>
            </li>
            <li data-section="section-3-5" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-3-5")}>3.5 How Docker Swarm Mode Works</button>
            </li>
            <li data-section="section-3-6" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-3-6")}>3.6 Application & Cluster Scaling</button>
            </li>
          </ul>
        </li>
        ...
        <li data-section="section-6" className={listElementStyle}>
          ...
          <ul className={subUlStyle}>
            ...
            <li data-section="section-6-2" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-6-2")}>6.2 Traefik Configuration Overview</button>
            </li>
            <li data-section="section-6-3" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-6-3")}>6.3Traefik Configuration for Canaries</button>
            </li>
            <li data-section="section-6-4" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-6-4")}>6.4 Promoting a Canary</button>
            </li>
            <li data-section="section-6-5" className={itemStyle}>
              <button className={textStyle} onClick={() => navigateTo("section-6-5")}>6.5 Rolling a Canary Back</button>
            </li>
          </ul>
        </li>
        ...
        <li data-section="section-8" className={listElementStyle}>
          <button className={textStyle} onClick={() => navigateTo("section-8")}>8. Upcoming Work</button>
        </li>

        <li data-section="section-9" className={listElementStyle}>
          <button className={textStyle} onClick={() => navigateTo("section-9")}>9. References</button>
        </li>
      </ul>
    </aside>
  );
